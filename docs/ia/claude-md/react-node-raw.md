---
id: react-node-raw
title: "CLAUDE.md — React + Node"
sidebar_label: "CLAUDE.md"
---

# CLAUDE.md — React + Node

Archivo CLAUDE.md listo para usar. Copialo a la raiz de tu proyecto y ajustalo a tus convenciones.

:::info Contribuir
[✏️ Sugerir correccion en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/claude-md/react-node/CLAUDE.md) — GitHub te propone hacer fork y PR automaticamente si no tenes permisos de push.
:::

<DownloadButton to="claude-md/react-node/CLAUDE.md">⬇ Descargar CLAUDE.md</DownloadButton>
...
- Usa `npx create` o templates del proyecto para scaffolding. No crees estructuras a mano.
