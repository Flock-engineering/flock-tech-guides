---
id: project-setup-skill-raw
title: "SKILL.md — Project Setup"
...
:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/project-setup/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/project-setup/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
