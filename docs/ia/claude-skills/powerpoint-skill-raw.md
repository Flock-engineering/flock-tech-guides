---
id: powerpoint-skill-raw
title: "SKILL.md — PowerPoint"
...
:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/powerpoint/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/powerpoint/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
