---
id: java-spring-boot-raw
title: "CLAUDE.md — Java Spring Boot"
...
:::info Contribuir
[✏️ Sugerir correccion en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/claude-md/java-spring-boot/CLAUDE.md) — GitHub te propone hacer fork y PR automaticamente si no tenes permisos de push.
:::

<DownloadButton to="claude-md/java-spring-boot/CLAUDE.md">⬇ Descargar CLAUDE.md</DownloadButton>

:::tip[Peso del archivo: ~1000 tokens]
**95 lineas · 645 palabras · ~1000 tokens.** Este template esta dentro del rango optimo. Un CLAUDE.md deberia mantenerse por debajo de ~2000 tokens para no sobrecargar el contexto. Recordá que se carga en CADA interaccion — cada linea que agregues consume contexto disponible para tu código.
:::
...
- Usa el Maven wrapper (`./mvnw`) para builds y dependencias. No uses `mvn` global.
- Usa Spring Initializr o arquetipos Maven para scaffolding. No crees estructuras a mano.
