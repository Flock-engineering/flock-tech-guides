---
id: post-work-skill-raw
title: "SKILL.md — Post-Work Summary"
sidebar_label: "SKILL.md"
---

# SKILL.md — Post-Work Summary

Archivo de instrucciones que Claude usa internamente. Si encontrás algo para mejorar, abrí un PR directamente.

:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/post-work/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/post-work/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
