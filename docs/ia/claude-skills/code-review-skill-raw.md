---
id: code-review-skill-raw
title: "SKILL.md — Code Review"
...
:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/code-review/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/code-review/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
