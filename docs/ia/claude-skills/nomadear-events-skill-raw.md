---
id: nomadear-events-skill-raw
title: "SKILL.md — Nomadear Events"
sidebar_label: "SKILL.md"
---

# SKILL.md — Nomadear Events

Archivo de instrucciones que Claude usa internamente. Si encontrás algo para mejorar, abrí un PR directamente.

:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/nomadear-events/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/nomadear-events/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
...
// Registra EventModification con action: 'SUSPENDED'
```
...
// Registra EventModification con action: 'RESTORED'
```
...
// Registra EventModification con action: 'CANCELLED'
