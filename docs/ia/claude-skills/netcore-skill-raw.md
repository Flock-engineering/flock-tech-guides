---
id: netcore-skill-raw
title: "SKILL.md — NetCore"
...
:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/netcore/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/netcore/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
