---
id: angular-nestjs-raw
title: "CLAUDE.md — Angular + NestJS"
...
:::info Contribuir
[✏️ Sugerir correccion en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/claude-md/angular-nestjs/CLAUDE.md) — GitHub te propone hacer fork y PR automaticamente si no tenes permisos de push.
:::

<DownloadButton to="claude-md/angular-nestjs/CLAUDE.md">⬇ Descargar CLAUDE.md</DownloadButton>

:::tip[Peso del archivo: ~1000 tokens]
**95 lineas · 643 palabras · ~1000 tokens.** Este template esta dentro del rango optimo. Un CLAUDE.md deberia mantenerse por debajo de ~2000 tokens para no sobrecargar el contexto. Recordá que se carga en CADA interaccion — cada linea que agregues consume contexto disponible para tu código.
:::
...
- Usa `pnpm` para manejar dependencias. No uses `npm` ni `yarn`.
- Usa `ng generate` para crear componentes, servicios y modulos. No crees archivos a mano.
