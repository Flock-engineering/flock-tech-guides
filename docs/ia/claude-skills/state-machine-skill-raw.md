---
id: state-machine-skill-raw
title: "SKILL.md — State Machine"
...
:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/state-machine/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/state-machine/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
