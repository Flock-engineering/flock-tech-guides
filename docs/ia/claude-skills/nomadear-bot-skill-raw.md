---
id: nomadear-bot-skill-raw
title: "SKILL.md — Nomadear Bot"
sidebar_label: "SKILL.md"
---

# SKILL.md — Nomadear Bot

Archivo de instrucciones que Claude usa internamente. Si encontrás algo para mejorar, abrí un PR directamente.

:::info Contribuir
[✏️ Sugerir corrección en GitHub](https://github.com/Flock-engineering/flock-tech-guides/edit/dev/static/skills/nomadear-bot/SKILL.md) — GitHub te propone hacer fork y PR automáticamente si no tenés permisos de push.
:::

<DownloadButton to="skills/nomadear-bot/SKILL.md">⬇ Descargar SKILL.md</DownloadButton>
